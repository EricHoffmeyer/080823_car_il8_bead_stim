...
il8_gss_mat <- gs_scores(
  se = vst(il8.sf.df.dds),
  res_de = il8.res.sf.df.dds,
  res_enrich = il8.topgo.res.sf.df.dds,
  annotation_obj = il8.sf.df.annotation
)

il8_gss_plot <- gs_scoresheat(
  il8_gss_mat,
  n_gs = 15
)
#Save plot
ggsave("plots/il8_pathway_heatmap.png",
       plot = il8_gss_plot,
       device = "png",
       width = 8,
       height = 6,
...
temp <- gs_summary_overview(
  res_enrich = res_enhanced,
  n_gs = 15
)

ggsave("plots/il8_pathway_analysis.png",
       plot = temp,
       device = "png",
       width = 8,
       height = 6,
