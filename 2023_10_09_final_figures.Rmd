...
I can't quite figure out how to make changes to this gs_heatmap object. It may be easier to use the raw data and make a pHeatmap. First, let me extract the genes of interest for the innate immune response pathway from this gs_heatmap object
...
Now to read in the DESeq results
...
Preparing the annotation names and colors here
